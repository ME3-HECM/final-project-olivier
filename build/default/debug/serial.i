...
void RGB2Hue(struct RGBC_rel *cf,int *h);
# 5 "./serial.h" 2
...
void Color2String(char *buf,struct RGBC_rel *colorf,int *h);
# 2 "serial.c" 2
...
void Color2String(char *buf,struct RGBC_rel *colorf,int *h){
    ...
    sprintf(buf,"Red %d Green,%d Blue,%d Hue %d \r",colorf->Rf,
    colorf->Gf,colorf->Bf,*h);
