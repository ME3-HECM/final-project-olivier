...
unsigned int _45dleftdelay = 160;
unsigned int _45drightdelay = 160;
...
void Left45(struct DC_motor *mL, struct DC_motor *mR)
{
    ...
    turnLeft(mL,mR);
    _delay((unsigned long)((_45dleftdelay)*(64000000/4000.0)));
    stop(mL,mR);
    _delay((unsigned long)((50)*(64000000/4000.0)));
    LATFbits.LATF0 = 0;;
}
...
void reverseHalfSquare(struct DC_motor *mL, struct DC_motor *mR)
{
    ...
    _delay((unsigned long)((_halfsquare)*(64000000/4000.0)));
    stop(mL,mR);
    _delay((unsigned long)((100)*(64000000/4000.0)));
}
